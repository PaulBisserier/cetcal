...
-- Sun 14 Jun 2020 01:34:25 PM CEST
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cet_sondage` (
  ...
  `fk_qstprod_idpkai_producteur` INT NOT NULL,
  `question` VARCHAR(60) NOT NULL,
  `reponse` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`cet_sondage_idpkai`),
  INDEX `fk_cet_sondage_qstprod_producteur_idx` (`fk_qstprod_idpkai_producteur` ASC),
  CONSTRAINT `fk_qstprod_idpkai_producteur`
    FOREIGN KEY (`fk_qstprod_idpkai_producteur`)
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cetcal_lieu` (
  ...
  INDEX `fk_qstprod_idpkai_producteur_idx` (`fk_qstprod_idpkai_producteur` ASC),
  CONSTRAINT `fk_qstprod_idpkai_producteur`
    FOREIGN KEY (`fk_qstprod_idpkai_producteur`)
    REFERENCES `cetcal`.`qstprod_producteur` (`qstprod_idpkai_producteur`)
    ON DELETE NO ACTION
