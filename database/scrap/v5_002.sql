...
-- Sat 20 Jun 2020 07:09:20 PM CEST
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cetcal_type_production` (
  ...
  INDEX `fk_producteur_idx` (`fk_producteur` ASC),
  CONSTRAINT `fk_producteur`
    FOREIGN KEY (`fk_producteur`)
    REFERENCES `cetcal`.`cetcal_producteur` (`pk_producteur`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cetcal_mode_conso` (
  ...
  INDEX `fk_cetcal_mode_commande_cetcal_producteur1_idx` (`fk_producteur` ASC),
  CONSTRAINT `fk_producteur`
    FOREIGN KEY (`fk_producteur`)
    REFERENCES `cetcal`.`cetcal_producteur` (`pk_producteur`)
    ON DELETE NO ACTION
