...
-- Sat 20 Jun 2020 11:19:13 AM CEST
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cetcal_sondage` (
  ...
  `val_question` VARCHAR(45) NOT NULL,
  `reponse` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`pk_sondage`),
  INDEX `fk_cet_sondage_qstprod_producteur_idx` (`fk_producteur` ASC),
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cetcal_information_producteur` (
  ...
  `val_information` VARCHAR(128) NOT NULL,
  `information` VARCHAR(128) NOT NULL,
  PRIMARY KEY (`pk_question_producteur`),
  INDEX `fk_qstprod_idpkai_producteur_idx` (`fk_producteur` ASC),
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cetcal_type_production` (
  ...
  `val_type_production` VARCHAR(128) NULL,
...
-- -----------------------------------------------------
-- Table `cetcal`.`specificite_join_producteur`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cetcal`.`specificite_join_producteur` (
  `fk_specificites_produits` INT NOT NULL,
  `fk_producteur` INT NOT NULL,
  PRIMARY KEY (`fk_specificites_produits`, `fk_producteur`),
  INDEX `fk_cetcal_specificites_produits_has_cetcal_producteur_cetca_idx` (`fk_producteur` ASC),
  INDEX `fk_cetcal_specificites_produits_has_cetcal_producteur_cetca_idx1` (`fk_specificites_produits` ASC),
  CONSTRAINT `fk_cetcal_specificites_produits_has_cetcal_producteur_cetcal_1`
    FOREIGN KEY (`fk_specificites_produits`)
    REFERENCES `cetcal`.`cetcal_specificite_produits` (`pk_specificites_produits`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cetcal_specificites_produits_has_cetcal_producteur_cetcal_2`
    FOREIGN KEY (`fk_producteur`)
    REFERENCES `cetcal`.`cetcal_producteur` (`pk_producteur`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `cetcal`.`typeproduction_join_producteur`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cetcal`.`typeproduction_join_producteur` (
  `fk_type_production` INT NOT NULL,
  `fk_producteur` INT NOT NULL,
  PRIMARY KEY (`fk_type_production`, `fk_producteur`),
  INDEX `fk_cetcal_type_production_has_cetcal_producteur_cetcal_prod_idx` (`fk_producteur` ASC),
  INDEX `fk_cetcal_type_production_has_cetcal_producteur_cetcal_type_idx` (`fk_type_production` ASC),
  CONSTRAINT `fk_cetcal_type_production_has_cetcal_producteur_cetcal_type_p1`
    FOREIGN KEY (`fk_type_production`)
    REFERENCES `cetcal`.`cetcal_type_production` (`pk_type_production`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cetcal_type_production_has_cetcal_producteur_cetcal_produc1`
    FOREIGN KEY (`fk_producteur`)
    REFERENCES `cetcal`.`cetcal_producteur` (`pk_producteur`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
