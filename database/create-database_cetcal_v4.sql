...
-- Tue 30 Jun 2020 06:08:42 PM CEST
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cetcal_producteur` (
  ...
  `surfacehectterres` VARCHAR(64) NULL,
  `surfacesousserre` VARCHAR(64) NULL,
  `tetes_betail` VARCHAR(64) NULL,
  `hl_par_an` VARCHAR(64) NULL,
  `groupe_cagette` VARCHAR(60) NULL,
  `identifiant_cet` VARCHAR(20) NOT NULL,
  `opinions` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cetcal_produit` (
  ...
  `quantite_uni` VARCHAR(64) NULL,
  `quantite_mesure` VARCHAR(64) NULL,
...
CREATE TABLE IF NOT EXISTS `cetcal`.`cetcal_lieu` (
  ...
  `jour_producteur` VARCHAR(256) NULL,
  `jour_collecte_conso` VARCHAR(256) NULL,
  PRIMARY KEY (`pk_lieu`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
